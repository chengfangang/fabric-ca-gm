...
SCRIPTDIR="/etc/zhigui/zigledger-ca"
...
# RootCa variables
RootCa='ZigledgerTlsRootCa'
RootSubject="/C=US/ST=North Carolina/L=RTP/O=Zhigui/OU=zigledger-ca/CN=$RootCa/"
RootEmail="$RootCa@localhost"

# SubCa variables
SubCa='ZigledgerTlsSubCa'
SubSubject="/C=US/ST=North Carolina/L=RTP/O=Zhigui/OU=zigledger-ca/CN=$SubCa/"
SubEmail="$SubCa@localhost"

# TlsRa variables
TlsRa='ZigledgerTlsRa'
TlsRaSubject="/C=US/ST=North Carolina/L=RTP/O=Zhigui/OU=zigledger-ca/CN=$TlsRa/"
TlsRaEmail="$TlsRa@localhost"

# TlsServerEE variables
TlsServerEE='ZigledgerTlsServerEE'
TlsServerSubject="/C=US/ST=North Carolina/L=RTP/O=Zhigui/OU=zigledger-ca/CN=$TlsServerEE/"
TlsServerEmail="$TlsServerEE@localhost"

# TlsClientEE variables
TlsClientEE='ZigledgerTlsClientEE'
TlsClientSubject="/C=US/ST=North Carolina/L=RTP/O=Zhigui/OU=zigledger-ca/CN=$TlsClientEE/"
...
cat ${TlsRa}*cert.pem ${SubCa}*cert.pem ${RootCa}*cert.pem > ZigledgerTlsPkiBundle.pem
