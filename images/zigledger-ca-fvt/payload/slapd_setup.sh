...
cp $ZIGLEDGER_CA_DATA/$TLS_BUNDLE /etc/ssl/certs/
cp $ZIGLEDGER_CA_DATA/$TLS_SERVER_CERT /etc/ssl/certs/
cp $ZIGLEDGER_CA_DATA/$TLS_SERVER_KEY /etc/ssl/private/$TLS_SERVER_KEY
cp $ZIGLEDGER_CA_DATA/*ldif /etc/ldap/
