...
// Version specifies zigledger-ca-client/zigledger-ca-server version
// It is defined by the Makefile and passed in with ldflags
var Version string

// GetVersionInfo returns version information for the zigledger-ca-client/zigledger-ca-server
...
func GetVersion() string {
	if Version == "" {
		//panic("Version is not set for zigledger-ca library")
		Version = "1.1.0"
	}
	return Version
}
