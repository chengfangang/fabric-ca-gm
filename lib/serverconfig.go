...
import "github.com/chengfangang/fabric-ca-gm/lib/tls"

const (
	// DefaultServerPort is the default listening port for the zigledger-ca server
	DefaultServerPort = 7054

	// DefaultServerAddr is the default listening address for the zigledger-ca server
	DefaultServerAddr = "0.0.0.0"
)

// ServerConfig is the zigledger-ca server's config
...
type ServerConfig struct {
	...
	Port int `def:"7054" opt:"p" help:"Listening port of zigledger-ca-server"`
	// Bind address for the server
	Address string `def:"0.0.0.0" help:"Listening address of zigledger-ca-server"`
