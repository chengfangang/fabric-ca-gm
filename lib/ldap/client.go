...
type AttrConfig struct {
	...
	Converters []NameVal            // Used to convert an LDAP entry into a zigledger-ca-server attribute
	Maps       map[string][]NameVal // Use to map an LDAP response to zigledger-ca-server names
}
