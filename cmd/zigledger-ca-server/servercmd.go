...
// for the Zigledger CA server and the configuration used by the Zigledger CA server
type ServerCmd struct {
	// name of the zigledger-ca-server command (init, start, version)
	name string
...
func (s *ServerCmd) init() {
	...
	var versionCmd = &cobra.Command{
		Use:   "version",
		Short: "Prints Zigledger CA Server version",
...
func (s *ServerCmd) registerFlags() {
	...
	tags := map[string]string{
		"help.csr.cn":           "The common name field of the certificate signing request to a parent zigledger-ca-server",
		"help.csr.serialnumber": "The serial number in a certificate signing request to a parent zigledger-ca-server",
		"help.csr.hosts":        "A list of space-separated host names in a certificate signing request to a parent zigledger-ca-server",
	}
