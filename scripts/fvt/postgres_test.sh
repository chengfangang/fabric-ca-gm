...
SERVERLOG="$ZIGLEDGER_CA_SERVER_HOME/serverlog.txt"
...
db:
  type: postgres
  datasource: host=localhost port=$POSTGRES_PORT user=testuser password=testuserpw dbname=zigledger_ca $postgresTls
  tls:
